...
function Private() {
  ...
  const handleClick = () => {
    if (className === "Output1") {
      setClassName("Output");
    } else {
      setClassName("Output1");
    }
  };
  const flighttime = (e) => {
  ...
  return (
    <div className="Private">
      <main>
        ...
        <div className="Info">
          <h2>Choose Our Tour Plans</h2>
        </div>
        <div className="Info-hor">
          <div className="Info-Box">
            <h1>London To Dubai</h1>
            <p>Internation-Trips</p>
          </div>
